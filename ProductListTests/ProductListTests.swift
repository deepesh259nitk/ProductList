    ...
    func testParseData(){
        ...
        for (productIndex, aProduct) in self.productList.enumerated() {
            ...
            case 0:
                ...
                XCTAssertEqual(aProduct.imageURL, "https://cache.net-a-porter.com/images/products/802851/802851_fr_sl.jpg", "Product Image URL does not match")
            ...
            case 1:
                ...
                XCTAssertEqual(aProduct.imageURL, "https://cache.net-a-porter.com/images/products/802856/802856_fr_sl.jpg", "Product Image URL does not match")
            ...
            case 2:
                ...
                XCTAssertEqual(aProduct.imageURL, "https://cache.net-a-porter.com/images/products/802852/802852_fr_sl.jpg", "Product Image URL does not match")
            ...
            case 3:
                ...
                XCTAssertEqual(aProduct.imageURL, "https://cache.net-a-porter.com/images/products/752202/752202_fr_sl.jpg", "Product Image URL does not match")
            ...
            case 4:
                ...
                XCTAssertEqual(aProduct.imageURL, "https://cache.net-a-porter.com/images/products/716656/716656_fr_sl.jpg", "Product Image URL does not match")
